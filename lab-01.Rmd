...
#NA represents a missing value in a set of data, when calculating the median or mean of a data set which includes an NA value, the NA will prevent the code returning a value.
